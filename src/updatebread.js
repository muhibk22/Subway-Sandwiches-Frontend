...
function Updatebread() {
  ...
  const handleFormSubmit = async (event) => {
    ...
    const updatedData = { name, type, quantity, price, availability };
  
    try {
      const response = await fetch(`http://localhost:5000/api/bread/updatebread`, {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="App">
      <h1 className="text">Update Bread Record</h1>
      {!record ? (
